##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [2.27.0] date: [Sun Apr 15 23:37:23 MSK 2018] 
##########################################################################################################################
...
Application/User/Src/stm32f3xx_hal_timebase_TIM.c \
...
Middlewares/FreeRTOS/portable/MemMang/heap_3.c \
...
# binaries
#######################################
BINPATH = /usr/local/gcc-arm-none-eabi-5_4-2016q3/bin/
...
#######################################
# link script
LDSCRIPT = STM32F373C8Tx_FLASH.ld
...
#######################################
upload:
	dfu-util -v -d 0483:df11 -a 0 -s 0x08000000 -D build/${TARGET}.bin

upload_sn:
	dfu-util -v -d 0483:df11 -a 0 -s 0x0800F000 -D sn.bin

default_settings:
	dfu-util -v -d 0483:df11 -a 0 -s 0x0800F800 -D null.bin
